...
@org.springframework.web.bind.annotation.ControllerAdvice(
    basePackages = {"com.cooksys.socialmedia.controllers"})
public class SocialMediaControllerAdvice {

  /**
   * Handles and responds to BadRequestException by returning an ErrorDto with the exception
   * message.
   *
  ...
  /**
   * Handles and responds to NotAuthorizedException by returning an ErrorDto with the exception
   * message.
   *
   * @param request The HTTP servlet request associated with the exception.
